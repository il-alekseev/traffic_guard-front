...
import type { SessionTable, SessionControlState } from '~/types/sessionControl';
...
export const useSessionsControlStore = defineStore("userControl", {
  ...
  actions: {
    async fetchSessions(page: number = 1, limit: number = 11, search?: string): Promise<SessionTable> {
      ...
      //   const sessions = await $api.get<SessionTable>('/users', {
      //     params,
